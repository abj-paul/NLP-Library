...
void ConfusionMatrix::load_confusion_matrices(){
  this->extract_content_from_file_into_matrix(new abj::String("./Resources/INSERTION_CONFUSION_MATRIX.txt"), new abj::String(ID_INSERTION));
  this->extract_content_from_file_into_matrix(new abj::String("./Resources/DELETION_CONFUSION_MATRIX.txt"),new abj::String(ID_DELETION));
  this->extract_content_from_file_into_matrix(new abj::String("./Resources/SUBTITION_CONFUSION_MATRIX.txt"), new abj::String(ID_SUBSTITUTION));
  this->extract_content_from_file_into_matrix(new abj::String("./Resources/TRANSPOSITION_CONFUSION_MATRIX.txt"), new abj::String(ID_TRANSPOSITION));
}
